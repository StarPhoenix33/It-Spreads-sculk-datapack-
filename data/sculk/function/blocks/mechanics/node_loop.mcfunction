...
execute as @e[tag=sculk,tag=sensor,tag=!massharvested,limit=500,sort=nearest,distance=..60] if predicate sculk:sensor_passive_mass_chance run scoreboard players add .mass HIVEMIND 1
tag @e[tag=sculk,tag=sensor,tag=!massharvested,limit=500,sort=nearest,distance=..60] add massharvested
