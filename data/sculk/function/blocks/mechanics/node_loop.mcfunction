...
execute at @s[scores={node_stage=2}] if score @s infected_blocks matches 400.. if score .mass HIVEMIND matches 500.. run function sculk:blocks/mechanics/node_evolve {"mass":200}
execute at @s[scores={node_stage=3}] if score @s infected_blocks matches 1000.. if score .mass HIVEMIND matches 2000.. run function sculk:blocks/mechanics/node_evolve {"mass":500}
