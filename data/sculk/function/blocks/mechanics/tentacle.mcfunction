...
execute unless entity @n[tag=sculk,tag=node,distance=..4] unless block ~ ~ ~ #sculk:sculk_variants unless block ~ ~ ~ spawner unless block ~ ~ ~ command_block run function sculk:delete
...
execute store result storage sculk:hivemind turn int 1 run random value -30..30
