...
execute if score @n[tag=sculk,tag=sensor,distance=..8] temp matches 5.. run return fail
...
execute as @s[tag=sculk,tag=tendril,tag=sculkstuck,scores={sculk_steps=2..}] run scoreboard players remove @s sculk_steps 2
